...
후속 Runtime OFF Saved Plan `tfplan-runtime-off-after-websocket-origin-fix`, 193,775 bytes, SHA-256 `e2c7f108b3197696a7e9e4b2cde1fc3d717fc10cc81028bbaee7573107835831`을 준비했다. ECS Service 8개와 ASG 1개를 축소하고 Public ALB·HTTPS·Gateway Rule 2개·`origin`·Valkey 6개만 삭제해 `0 added, 9 changed, 11 destroyed`다. RDS·Task Definition·Image·Frontend·Network·IAM·Secret 변경은 없으며 Redis Password도 직렬화되지 않았다. 별도 Hash 승인 전에는 Apply와 RDS 정지를 수행하지 않는다.
