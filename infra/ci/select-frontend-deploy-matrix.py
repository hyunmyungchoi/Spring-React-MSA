...
FRONTEND_DEPLOYMENTS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "workspace": "@springmsa/member-community",
        "build_script": "build",
        "output_dir": "FrontEnd/apps/member-community/dist",
        "entry_document": "index.html",
    ...
    },
    {
        ...
        "workspace": "@springmsa/member-stock",
        "build_script": "build",
        "output_dir": "FrontEnd/apps/member-stock/dist",
        "entry_document": "index.html",
        "bucket_key": "stock",
        "distribution_group": "member",
    ...
    },
    {
        ...
        "workspace": "@springmsa/admin-users",
        "build_script": "build",
        "output_dir": "FrontEnd/apps/admin-users/dist",
        "entry_document": "index.html",
    ...
    },
    {
        ...
        "workspace": "@springmsa/admin-logs",
        "build_script": "build",
        "output_dir": "FrontEnd/apps/admin-logs/dist",
        "entry_document": "index.html",
