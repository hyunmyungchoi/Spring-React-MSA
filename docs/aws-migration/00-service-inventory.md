...
- Internal service URLs: `USER_SERVICE_BASE_URL`, `BFF_API_USER_API_BASE_URL`, `BFF_API_USER_INTERNAL_BASE_URL`, `BFF_API_COMMUNITY_API_BASE_URL`, `BFF_API_STOCK_API_BASE_URL`, `ADMIN_BFF_API_USER_API_BASE_URL`
...
- Admin 생성 경계: 공개 가입 없이 `AdminBootstrapMain` 일회성 Task만 사용
