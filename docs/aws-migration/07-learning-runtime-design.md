...
> 문서 상태: Hikari `5/1` 재측정·Runtime OFF와 RDS Alarm 5개·Member BFF Prometheus 200/404 Runtime ON 적용·전체 Smoke 완료, Runtime OFF Saved Plan 적용 전
>
> 기준일: 2026-07-24
>
...
>
> AWS 적용 상태: Runtime ON Plan `40/10/0` 적용과 전체 Smoke를 완료했다. 현재 State serial 125·주소 291개, ECS·Container Health 8/8, ASG `1/1/2`, RDS·Valkey·ALB available/active, Target 2/2·Cloud Map 8/8, 관련 Alarm 37/37 정상이다. 후속 Runtime OFF Saved Plan SHA-256 `9a4ce0c1e778c874c115806d0135987559c289d50d804835588a35e60d7ff69f`은 `0/10/40`으로 생성·검증했으며 아직 적용하지 않았다.
...
27. 다음: 검증된 Runtime OFF Saved Plan 적용, Runtime 종료·정적 curl·RDS 정지
...
- 다음: 검증된 Runtime OFF Saved Plan 적용, Runtime 종료·정적 curl·RDS 정지
