...
> 문서 상태: Hikari `5/1` 재측정과 RDS Alarm 5개·Member BFF Prometheus 200/404 Runtime ON 전체 Smoke, 후속 Runtime OFF·RDS 정지 완료
>
> 기준일: 2026-07-24
>
...
>
> AWS 적용 상태: Runtime ON 전체 Smoke 뒤 OFF Plan SHA-256 `9a4ce0c1e778c874c115806d0135987559c289d50d804835588a35e60d7ff69f`을 `0/10/40`으로 적용했다. 현재 State serial 131·주소 251개, ECS/Task/Container Instance·ASG Instance·ALB·Valkey·`origin`·Runtime Alarm은 모두 0이고 Container Insights는 disabled다. RDS는 stopped, 영속 RDS Alarm 5개·Watchdog Alarm 3개와 SNS·Task Definition/Image 8개·Frontend를 유지한다.
...
28. 다음: Applied Saved Plan·임시 로그 정리와 최종 AWS·문서 감사
...
- 다음: Applied Saved Plan·임시 로그 정리와 최종 AWS·문서 감사
