...
후속 비용 종료 Saved Plan `tfplan-runtime-off-after-websocket-origin-fix`, 193,775 bytes, SHA-256 `e2c7f108b3197696a7e9e4b2cde1fc3d717fc10cc81028bbaee7573107835831`을 준비했다. 변경은 ECS Service 8개와 ASG 1개 축소, Public ALB·HTTPS Listener·Gateway Rule 2개·`origin` A Alias·Valkey 6개 삭제로 정확히 `0 added, 9 changed, 11 destroyed`다. RDS·Task Definition·Image·Frontend·Network·IAM·Secret 변경은 없고 Redis Password는 Plan JSON에 직렬화되지 않았다. Hash 승인 전에는 Apply하거나 RDS를 정지하지 않는다.
