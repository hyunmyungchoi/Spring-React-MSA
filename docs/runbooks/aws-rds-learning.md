...
> 기준일: 2026-07-23
>
> 현재 상태: Hikari `5/1` 재측정 Runtime ON과 30분 전체 Smoke 완료; 원본 RDS `available`, ECS 8/8, State serial 113; 검증된 Runtime OFF Plan `0/10/40` 생성 완료·Apply 승인 대기
>
...
Runtime OFF Saved Plan `tfplan-rds-hikari-runtime-off`은 State serial 113 기준 `0 add, 10 change, 40 destroy`, SHA-256 `5e3f9b9a03dceab9eb57491b57b05a8c090693c2c41c10f047ee2c9b86cd779d`다. Runtime 실행 용량·ALB·Valkey·Alarm만 종료하고 RDS·Task Definition·Secret·Frontend·Watchdog·감사 Log는 변경하지 않는다. Gate 만료는 `2026-07-24 03:35:38.853 KST`다. 승인 Apply와 실행 용량 0 수렴 뒤 RDS를 별도로 정지하고 자동 재시작 시각을 기록한다.
